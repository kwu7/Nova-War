...
/**
 * Renders ships and corresponding shots. Checks collision between ships and
 * whether ships have been hit.
 * 
...
public class Play extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1) throws SlickException {
		...
		player2 = new Image("IMG/ship.png", true, 60);
	...
	public void render(GameContainer gc, StateBasedGame arg1, Graphics g) throws SlickException {
		...
		if (p1.getHp() < 1 && p2.getHp() < 1) {
			g.drawString(String.format("Two warriors leave this plane in disgrace%nto begin anew press space"), 10,
					200);

			if ((endTimer >= 100) && (endTimer <= 2150)) {
	...
	/**
	 * Checks if ships have collided if true moves them apart
	 * 
	 */
	public void CheckColision() {
		...
		if (((shipDiffY <= 45) && (shipDiffY >= 0))
				&& ((shipDiffX >= -30 && shipDiffX <= 0) || (shipDiffX <= 30 && shipDiffX >= 0))) {
			p1.minusHp(100);
			p2.minusHp(100);
			p1.yPos += 30;
			p2.yPos -= 30;
